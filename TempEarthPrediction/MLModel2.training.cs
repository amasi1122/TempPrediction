...
namespace TempEarthPrediction
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Amasi\source\repos\TempEarthPrediction\TempEarthPrediction\Average Temperature 1900-2023-New.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:10,seriesLength:655,trainSize:124,horizon:10,outputColumnName:@"TempC",inputColumnName:@"TempC",confidenceLowerBoundColumn:@"TempC_LB",confidenceUpperBoundColumn:@"TempC_UB");

...
namespace TempEarthPrediction
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Amasi\Desktop\archive\Average Temperature 1900-2023-New.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"Year", @"Year")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=6,NumberOfLeaves=21,FeatureFraction=0.93989277F,LabelColumnName=@"TempC",FeatureColumnName=@"Features"}));
